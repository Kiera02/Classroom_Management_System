 ...
 * @author minhh
 */
public final class lecturerGUI extends javax.swing.JFrame {
    ...
    public void dataLoad() {
        ...
        try {
            ...
            pst = conn.prepareStatement("select * from lecturer");
            rs = pst.executeQuery();
            ...
            Logger.getLogger(lecturerGUI.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Lecturer ID", "Full Name", "Email", "Major"
            }
        ));
        ...
        jLabel5.setText("Lecturer Manage");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(findButton, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(majorField, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(findButton, javax.swing.GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
                    .addComponent(resetButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        Lecturer lecturer = new Lecturer(ID, name, email, major);
        controller.add(lecturer);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        nameField.setText(d.getValueAt(selecIndex, 1).toString());
        emailField.setText(d.getValueAt(selecIndex, 2).toString());
        majorField.setText(d.getValueAt(selecIndex, 3).toString());
    ...
    private void findButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findButtonActionPerformed
        ...
        List<Lecturer> lecturer = controller.findByID(IDField.getText());
        
        for(int i = 0; i < lecturer.size(); i++) {
                        Vector v = new Vector();

                    v.add(lecturer.get(i).getID());
                    v.add(lecturer.get(i).getName());
                    v.add(lecturer.get(i).getEmail());
                    v.add(lecturer.get(i).getLecturerMajor());
